...
class PostPatch(BaseModel):
    ...
    content: Optional[StrictStr] = Field(default=None, description="Content of the post in Markdown format")
    ...
    visibility: Optional[StrictStr] = Field(default='draft', description="Visibility state of the post: draft, review, or public")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PostPatch from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PostPatch from a dict"""
        if obj is None:
            return None

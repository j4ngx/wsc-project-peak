...
class PostResponse(BaseModel):
    ...
    PostResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the post")
    ...
    created_at: datetime = Field(description="Timestamp when the post was created", alias="createdAt")
    updated_at: datetime = Field(description="Timestamp when the post was last updated", alias="updatedAt")

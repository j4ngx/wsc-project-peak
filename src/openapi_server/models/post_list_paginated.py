...
class PostListPaginated(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PostListPaginated from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PostListPaginated from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [Post.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
